...
As best as possible, only actual Z Launcher code is tested, not standard Android system behavior.
...
* [ ] When going back to Z Launcher, search results have been cleared
* [ ] When going back to Z Launcher, the item has been added to history
...
* [ ] With Z Launcher set as default launcher, pressing home empties the search field and displays history
* [ ] With Z Launcher set as default launcher and app list displayed, pressing home hides the app list and displays history
...
* [ ] When history is displayed, pressing back does not quit Z Launcher
...
* [ ] When going back to Z Launcher, the favorite has been added to history
...
* [ ] Z Launcher bar background is properly tinted according to the primary color
...
* [ ] TODO: root mode
* [ ] "Restart Z Launcher" option closes the settings and reopen Z Launcher
